...
CuckooParam k2n24s40CuckooParam { 2.4, 2, 21 };
CuckooParam k2n20s40CuckooParam { 2.4, 2, 20 };
CuckooParam k2n16s40CuckooParam { 2.4, 2, 19 };
CuckooParam k2n12s40CuckooParam { 2.4, 2, 18 };
CuckooParam k2n08s40CuckooParam { 2.4, 2, 17 };

// not sure if this needs a stash of 40, but should be safe enough.
// CuckooParam k2n07s40CuckooParam { 2.4, 2, 17 };
CuckooParam k2n07s40CuckooParam { 2.4, 2, 17 };
...
void CuckooHasher::init(u64 n, u64 statSecParam)
{
