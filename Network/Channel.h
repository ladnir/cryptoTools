...
namespace osuCrypto {
    ...
    //    //    virtual void asyncSend(Container&& data) {};
    ...
    //    /// <summary>Synchronous call to receive data over the network. Will *TRY* to resize buffer to be the appropriate size. A MoveChannelBuff may refuse to resize...</summary>
