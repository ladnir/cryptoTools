...
namespace osuCrypto {
	...
	namespace details
	{
		...
		void AESDec<NI>::setKey(const block& userKey)
		{
			...
			const block  v1 = details::keyGenHelper<0x01, NI>(v0);
			const block  v2 = details::keyGenHelper<0x02, NI>(v1);
			const block  v3 = details::keyGenHelper<0x04, NI>(v2);
			const block  v4 = details::keyGenHelper<0x08, NI>(v3);
			const block  v5 = details::keyGenHelper<0x10, NI>(v4);
			const block  v6 = details::keyGenHelper<0x20, NI>(v5);
			const block  v7 = details::keyGenHelper<0x40, NI>(v6);
			const block  v8 = details::keyGenHelper<0x80, NI>(v7);
			const block  v9 = details::keyGenHelper<0x1B, NI>(v8);
			const block v10 = details::keyGenHelper<0x36, NI>(v9);
