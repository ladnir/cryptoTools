...
#if defined(_MSC_VER)
#define CRYPTOTOOLS_EDWARDS25519_ALIGN32 __declspec(align(32))
#else
#define CRYPTOTOOLS_EDWARDS25519_ALIGN32 __attribute__((aligned(32)))
#endif

typedef struct CRYPTOTOOLS_EDWARDS25519_ALIGN32 {
  double v[4];
} limb;

#undef CRYPTOTOOLS_EDWARDS25519_ALIGN32
