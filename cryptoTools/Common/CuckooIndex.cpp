...
namespace osuCrypto
{
    ...
    bool CuckooIndex::operator==(const CuckooIndex & cmp) const
    {
...
//
    ...
    void CuckooIndex::find(const u64& numItemsMaster, const block * hashesMaster, const u64 * idxsMaster)
    {
    ...
    bool CuckooIndex::Bin::isEmpty() const
    {
        return mVal == u64(-1);
    }
    ...
    void CuckooIndex::Bin::swap(u64 & idx, u64 & hashIdx)
    {
